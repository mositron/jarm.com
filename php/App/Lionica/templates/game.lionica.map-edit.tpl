...
._ct { width:auto; margin:0px auto; display:inline-block; text-align:left}
...
form table tr td i{display:inline-block; background:url(http://s0.boxza.com/static/images/game/lionica/sprite/map.png) 0px 0px no-repeat; position:absolute; left:0px; top:0px;}
form table tr td.c{background:#00CC00;}
#grid{position:absolute; cursor:pointer; overflow:visible; left:0px; top:0px; z-index:999;width:<?php echo ($this->map['width']*32)+1?>px;height:<?php echo ($this->map['height']*32)+1?>px; background:url(http://s0.boxza.com/static/images/game/lionica/ui/grid.png) 0px 0px repeat;}
...
<div class="controls"><input type="text" name="start" id="map-start" value="<?php echo is_array($this->map['start'])?implode(',',$this->map['start']):$this->map['start']?>"></div>
 ...
 <li><a href="javascript:;" class="s-block-1" onClick="draw.select('block','1')"><i style="background-position:0px 0px;width:32px;height:32px;" title="<?php echo $k?>"></i></a></li>
<p class="clear"></p>
</ul>
 <ul>
 <li><span>Background:</span></li>
 <?php foreach($this->block['bg'] as $k=>$v):?>
 <li><a href="javascript:;" onClick="draw.bg([<?php echo $v['x']?>,<?php echo $v['y']?>])"><i style="background-position:<?php echo $v['x']*-32?>px <?php echo $v['y']*-32?>px;width:32px;height:32px;" title="<?php echo $k?>"></i></a></li>
 <?php endforeach?>
<p class="clear"></p>
</ul>
 <ul>
 <li><span>Tileset:</span></li>
 <?php foreach($this->block['tile'] as $k=>$v):?>
 <li><a href="javascript:;" class="s-tile-<?php echo $v['y']?>-<?php echo $v['x']?>" onClick="draw.select('tile','<?php echo $v['y']?>-<?php echo $v['x']?>')"><i style="background-position:<?php echo $v['x']*-32?>px <?php echo $v['y']*-32?>px;width:32px;height:32px;" title="<?php echo $k?>"></i></a></li>
 <?php endforeach?>
<p class="clear"></p>
</ul>
 <ul>
 ...
 <li>
 <div class="obj" style="width:<?php echo ($v['w']*32)+1?>px;height:<?php echo ($v['h']*32)+1?>px; background-position:<?php echo $v['x']*-32?>px <?php echo $v['y']*-32?>px">
 <div class="obj-grid" data-offset="[<?php echo $v['x']?>,<?php echo $v['y']?>]" style="width:<?php echo ($v['w']*32)+1?>px;height:<?php echo ($v['h']*32)+1?>px;">
 </div>
 </div>
</li>
<?php endforeach?>
<p class="clear"></p>
 ...
 <ul>
 <li><span>NPC:</span></li>
 <?php foreach($this->monster['npc'] as $k=>$v):?>
 <li><a href="javascript:;" class="s-life-<?php echo $k?>" onClick="draw.select('life','<?php echo $k?>')"><i style="background:url(http://s0.boxza.com/static/images/game/lionica/life/<?php echo $k?>.png) -32px 0px no-repeat;width:32px;height:48px;" title="<?php echo $k?>"></i></a></li>
 <?php endforeach?>
<p class="clear"></p>
</ul>
 <ul>
 <li><span>Monster:</span></li>
 <?php foreach($this->monster['monster'] as $k=>$v):?>
 <li><a href="javascript:;" class="s-life-<?php echo $k?>" onClick="draw.select('life','<?php echo $k?>')"><i style="background:url(http://s0.boxza.com/static/images/game/lionica/life/<?php echo $k?>.png) -32px 0px no-repeat;width:32px;height:48px;" title="<?php echo $k?>"></i></a></li>
 <?php endforeach?>
<p class="clear"></p>
</ul>
 ...
 <li><a href="javascript:;" class="s-life-<?php echo $k?>" onClick="draw.select('life','<?php echo $k?>')"><i style="background:url(http://s0.boxza.com/static/images/game/lionica/life/<?php echo $k?>.png) 50% 0% no-repeat;<?php echo $v['size']?'width:'.$v['size']['w'].'px;height:'.$v['size']['h'].'px;':'width:32px;height:48px;'?>" title="<?php echo $k?>"></i></a></li>
 <?php endforeach?>
<p class="clear"></p>
</ul>
 <ul>
 <li><span>Warp / Farm / Animal:</span></li>
...
<p class="clear"></p>
 ...
 <li><div style="height:32px; line-height:32px;" id="debug"></div></li>
 <p class="clear"></p>
 </ul>
</div>
<div id="map">
