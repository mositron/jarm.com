...
<script>
function cdel(i){_.box.confirm({title:'ลบประกาศ',detail:'คุณต้องการลบแบนเนอร์นี้หรือไม่',click:function(){_.ajax.gourl('/relate','delbanner',i)}});}
</script>
...
<div class="row">
  <div class="col-sm-2">
    ...
    <ul class="nav-menu">
      <li<?php echo $this->status=='active'?' class="active"':''?>><a href="/relate/active"> &raquo; กำลังใช้งาน</a></li>
      <li<?php echo $this->status=='inactive'?' class="active"':''?>><a href="/relate/inactive"> &raquo; เลิกใช้งาน</a></li>
      <li<?php echo $this->status=='all'?' class="active"':''?>><a href="/relate/all"> &raquo; ทั้งหมด</a></li>
    </ul>
  </div>
  <div class="col-sm-10">
    <!--ul class="nav nav-tabs">
      <li<?php echo !$this->site?' class="active"':''?>><a href="/relate/<?php echo $this->status?>">ทุกโดเมน</a></li>
      <?php foreach($this->relate_position as $k=>$v):?>
      <li<?php echo $this->site==$k?' class="active"':''?>><a href="/relate/<?php echo $this->status?>/site-<?php echo $k?>"><?php echo $k?></a></li>
      <?php endforeach?>
    </ul-->
