...
<div><img src="<?php if($this->app['p']):?>//s.inetmass.com/appfb/<?php echo $this->app['fd']?>/<?php echo $this->app['p']?><?php endif?>" class="prv-img"></div>
</td></tr>
</table>
...
<img src="http://s.inetmass.com/images/fbapp/help-1.png"><br><br>
<p>2. คลิกที่ icon มุมบนของ tab ที่เราต้องการจะแก้</p>
<img src="http://s.inetmass.com/images/fbapp/help-2.png"><br><br>
<p>3. เลือก "แก้ไขการตั้งค่า" </p>
<img src="http://s.inetmass.com/images/fbapp/help-3.png"><br><br>
<p>4. ใส่รูปภาพ และชื่อของ tab ที่ต้องการ แล้วบันทึก </p>
<img src="http://s.inetmass.com/images/fbapp/help-4.png"><br><br>
</td></tr>
</table>
