...
<link rel="stylesheet" type="text/css" href="<?php echo FILES_CDN?>css/mobile.matching.css?<?php echo APP_VERSION?>">
...
<div class="bar-title">เกมจับคู่+</div>
<a href="/matching/print" class="bar-print"></a>
