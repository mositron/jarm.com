...
extract(Load::Split()->get('/guess/recent',1,['page']));
if(!$page || $page<1)$page=1;
list($pg,$skip)=Load::Pager()->navigation($pp,$count,['/guess/recent/','page-'],$page);

$app=$db->find('guess',['pl'=>1,'dd'=>['$exists'=>false]],['_id'=>1,'t'=>1,'d'=>1,'img'=>1,'c'=>1,'l'=>1,'fd'=>1,'p'=>1,'u'=>1,'do'=>1,'f'=>1],['sort'=>['_id'=>-1],'skip'=>$skip,'limit'=>$pp]);
...
Load::$core->data['content']=Load::$core->fetch('guess.recent');
