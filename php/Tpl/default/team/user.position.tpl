<ul class="breadcrumb">
	...
	<span class="divider">&raquo;</span>
	<li><a href="/user/position" title="">จัดการตำแหน่ง</a></li>
	<span></span>
  <li class="pull-right" style="margin:-3px -2px 1px 10px;"><a href="javascript:;" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-plus"></span> เพิ่มตำแหน่งใหม่</a></li>
	<span></span>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">เพิ่มตำแหน่งใหม่</h4>
        </div>
        <form action="<?php echo URL?>" class="form-horizontal" method="post" onsubmit="_.ajax.gourl('<?php echo URL?>','newposition',this);$('.modal').modal('hide');return false;">
          ...
          <tr>
            ...
            <td style="width:50px;">
              <div class="btn-group" style="width:30px;text-align:right">
								<button class="btn btn-xs btn-danger" onclick="_.box.confirm({'title':'ลบตำแหน่ง','detail':'ต้องการลบตำแหน่งนี้หรือไม่',click:function(){_.ajax.gourl('<?php echo URL?>','delposition',<?php echo $v['_id']?>)}})"><span class="glyphicon glyphicon-trash"></span></button>
              </div>
            </td>
          </tr>
          <?php endforeach ?>
