...
<ul class="breadcrumb" style="margin-bottom:5px;">
  ...
  <span class="divider">&raquo;</span>
   <li><a href="/advertorial/all"><span class="glyphicon glyphicon-eye-open"></span> บทความ</a></li>

<?php if($this->access):?>
    <li class="pull-right"><a href="/advertorial/all"><span class="glyphicon glyphicon-eye-open"></span> กลับไปหน้ารวม</a></li>
<?php else:?>
...
<a class="btn" href="/advertorial">ยกเลิก</a>
</div>
</div>
</fieldset>
</form>
