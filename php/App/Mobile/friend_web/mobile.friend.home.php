...
Load::Ajax()->register(['newfriend','delms','setuser']);
...
{
	$ajax=Load::Ajax();	
	$user=base64_encode(json_encode(['id'=>$arg['id'],'name'=>$arg['name']]));
	setcookie('fb',$user,time()+2592000,'/friend','mobile.jarm.com',false,true);
}
?>
