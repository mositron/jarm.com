...
<div class="n1"><span><?php echo implode('</span><span>',(array)$this->lotto['f3'])?></span></div>
...
<div class="n2"><span><?php echo $this->lotto['a1']?substr('000000'.(intval($this->lotto['a1'])-1),-6):''?></span><span><?php echo $this->lotto['a1']?substr('000000'.(intval($this->lotto['a1'])+1),-6):''?></span></div>
