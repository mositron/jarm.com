...
<div class="controls">
<textarea id="input09" style="height:60px;" class="form-control" name="detail" maxlength="1000" minlength="10" required><?php echo $this->post['detail']?></textarea>
...
<div class="controls">
<input type="file" id="input10" size="20" name="o" required>
