...
<h2 align="center" style="color:#000000; font-size:16px;">ลบข้อความภายใน Boxza Friend</h2>
...
คลิกที่ลิ้งค์ด้านล่างนี้เพื่อลบข้อความของคุณ<br>
 <a href="https://boyz.jarm.com/report/?delete=<?php echo $this->f['_id'].'.'.$this->code?>" style="color:#0399BE;">https://boyz.jarm.com/report/?delete=<?php echo $this->f['_id'].'.'.$this->code?></a><br>
