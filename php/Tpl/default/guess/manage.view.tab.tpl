...
.prv-guess h4{padding:5px; background:#f5f5f5; margin:5px 0px 5px}
.prv-guess img{float:left; margin:2px 5px 3px 0px; width:100px; height:70px;}
.prv-guess hr{margin:5px 0px; color:#fff; background:#fff; height:1px;border:none; border-bottom:1px solid #ccc}
.prv-guess p{clear:both}
...
<div><img src="<?php if($this->app['p']):?>//s4.jarm.com/guess/<?php echo $this->app['fd']?>/<?php echo $this->app['p']?><?php endif?>" class="prv-img"></div>
</td></tr>
</table>
...
<img src="https://s3.jarm.com/img/fbapp/help-1.png"><br><br>
<p>2. คลิกที่ icon มุมบนของ tab ที่เราต้องการจะแก้</p>
<img src="https://s3.jarm.com/img/fbapp/help-2.png"><br><br>
<p>3. เลือก "แก้ไขการตั้งค่า" </p>
<img src="https://s3.jarm.com/img/fbapp/help-3.png"><br><br>
<p>4. ใส่รูปภาพ และชื่อของ tab ที่ต้องการ แล้วบันทึก </p>
<img src="https://s3.jarm.com/img/fbapp/help-4.png"><br><br>
</td></tr>
</table>
