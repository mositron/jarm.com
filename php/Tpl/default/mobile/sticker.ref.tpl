<h3 class="sticker-bar">สติกเกอร์ <?php echo $this->ref[$this->c]['t']?></h3>
...
<div class="page-nav">
<?php if($this->page>1):?>
<a href="/sticker/ref/<?php echo $this->c?><?php echo $this->page>2?'/page-'.($this->page-1):''?>">ย้อนกลับ</a>
<?php endif?>
<?php if($this->page<$this->maxpage):?>
<a href="/sticker/ref/<?php echo $this->c?>/page-<?php echo $this->page+1?>">ถัดไป</a>
<?php endif?>
</div>