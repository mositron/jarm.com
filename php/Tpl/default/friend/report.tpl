...
<?php if(self::$my['am']&&$this->friend['fd']&&$this->friend['pt']):?> <input type="button" class="button" value=" ตั้งเป็นเพื่อนแนะนำ " onClick="_.ajax.gourl('/','setrec',<?php echo $this->friend['_id']?>);_.box.close()"> <?php endif?>
