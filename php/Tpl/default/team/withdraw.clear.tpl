        ...
        <table class="table table-hover table-striped">
          <thead>
            <tr>
              ...
              <th class="tb-col-date">ส่งเคลียร์บิลเมื่อ</th>
          ...
          <tbody>
            ...
            <tr>
							<td><a href="/withdraw/<?php echo $v['_id']?>"><?php echo $v['no']?></a></td>
							<!--td><a href="/withdraw/<?php echo $v['_id']?>"><?php echo $v['_id']?></a></td-->
							<td class="tb-col-date"><a href="/withdraw/<?php echo $v['_id']?>"><?php echo self::Time()->from($v['status7']['d'],'date')?></a></td>
							...
							<td style="text-align:center">
								<?php $u=team::user()->get($v['status5']['u'],true);?><a href="/user/<?php echo $u['_id']?>"><img src="<?php echo $u['img']?>" class="img-circle" style="width:32px;height:32px;" /></a>
