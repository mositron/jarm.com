...
<ul class="breadcrumb" style="margin-bottom:5px;">
  ...
  <span class="divider">&raquo;</span>
   <li><a href="/video"><span class="glyphicon glyphicon-eye-open"></span> วิดีโอทั้งหมด</a></li>
...
<div class="alert alert-success">
 ...
 ระบบทำการบันทึกข้อมูลเรียบร้อยแล้ว  (กลับไปยัง <a href="/video">แบนเนอร์ทั้งหมด </a>)
</div>
<?php endif?>
...
<div class="col-sm-10">
<label class="checkbox-inline"><input type="radio" name="type" onClick="checktype()" value="0"<?php echo !$this->banner['tyc']?' checked':''?>> ไฟล์วิดีโอ</label>
...
<div id="type_img">
<div class="form-group">
<label class="col-sm-2 control-label" for="input10">ไฟล์วิดีโอ:</label>
<div class="col-sm-10">
<?php if($this->banner['s']):?>
<a href="https://ads.jarm.com/_upload/banner/<?php echo $this->banner['fd']?>/<?php echo $this->banner['s']?>" target="_blank">https://ads.jarm.com/_upload/banner/<?php echo $this->banner['fd']?>/<?php echo $this->banner['s']?></a><br>
<?php endif?>
...
<?php foreach($this->video_position as $k=>$s):?>
...
<?php $c=($this->banner[$k]&&is_array($this->banner[$k][$x]))?$this->banner[$k][$x]:[];?>
<?php if($k=='teededball'):?>
...
<?php if($this->adsL):?>
<?php echo $this->adsL['t']?>
<a href="/view/<?php echo $this->adsL['_id']?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-tasks"></span></a>
...
<div class="col-sm-10" style="padding-top:7px;">
<?php if($this->adsR):?>
<?php echo $this->adsR['t']?>
<a href="/view/<?php echo $this->adsR['_id']?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-tasks"></span></a>
