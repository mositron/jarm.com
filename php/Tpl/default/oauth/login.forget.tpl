...
<div>กรุณายืนยันการเปลี่ยนรหัสผ่าน โดนการคลิกปุ่มด้านล่างนี้ เมื่อทำการคลิกปุ่มเรียบร้อยแล้ว ระบบจะทำการส่งรหัสผ่านใหม่มายังอีเมล์นี้อีกครั้ง</div>
<div>
...
<td style="background-color: #f70;color: #fff;height:30px; line-height:30px;">
 <a href="https://oauth.jarm.com/forget/<?php echo $this->u['_id']?>.<?php echo $this->forget?>"  style="display: inline-block;height:30px; line-height:30px;text-align: center;text-decoration: none;font-size: 14px; padding: 0px 14px; background-color: #f70;color: #fff;">ยืนยันการเปลี่ยนรหัสผ่าน</a>
</td>
</tr>
</table></div>
</div>
