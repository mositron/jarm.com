...
class Fbimage extends Service
{
  ...
  public function json_recent()
  {
    $ref=[
      ...
      '130185063856737', //ทูนหัวของบ่าว
      '311696612273483', //จอนนี่แมวศุภลักษณ์
      '1225060557634025', //เฉโปแมวโง่
      '198496713513140', //แฟนคลับแมวกล่อง
      '178944882137764', //แฟนคลับแมวตะกร้า
      '392237460795185', //แฟนคลับเจ้าเหมียวสนูปปี้
      '1534696463431854', //รังของแมวก๊อง
    ];
    ...
    $page=(int)$_GET['page'];
    $arg=['dd'=>['$exists'=>false],'fb'=>['$nin'=>$ref]];
